...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for i,hd in enumerate(dims[:self.L]):
            self.params['W' + str(i+1)] = np.random.randn(dims[i],dims[i+1])*weight_scale
            self.params['b' + str(i+1)] = np.random.randn(dims[i+1])
            #print('W' + str(i+1) + ' shape: ' + str(self.params['W'+str(i+1)].shape))
            #print('b' + str(i+1) + ' shape: ' + str(self.params['b'+str(i+1)].shape))
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
